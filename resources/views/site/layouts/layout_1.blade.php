...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo"><a href="{{url('/')}}">{{$settings['site_heading']}}</a></h1>
    ...
    <footer id="footer">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        ...
                        <p>We are available on social platforms</p>
        ...
        <div class="container py-4">
            ...
            <div class="credits">
                ...
                Designed by <a href="{{$settings['company_url']}}">{{$settings['company_name']}}</a>
            </div>
        </div>
    </footer><!-- End Footer -->
