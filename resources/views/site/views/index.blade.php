@extends('site.layouts.layout_1')
@section('content')
<!-- ======= Hero Section ======= -->
<section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
        <h1>Welcome to <span>Shiwkesh</span></h1>
        <h2>We are team of talented developers making customized software products</h2>
        <div class="d-flex">
    ...
    <section id="about" class="about section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                ...
                <p>We are a group of developers focussed on customer centric design and development of software services</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
                    <h3>What we pack is how we deliver.</h3>
                    <p class="fst-italic">
                        Below is a list of our organisational values which propels us as a team and helps us deliver as expected.
                    </p>
                    <ul>
                        <li>
                            <i class="bx bx-store-alt"></i>
                            <div>
                                <h5>What you expect is your right and what we can do best is our duty</h5>
                                <p>Focus should and is on delivering as the requirement is laid on. If there is some scope for improvements then it should be suggested</p>
                            </div>
                        </li>
                        <li>
                            <i class="bx bx-images"></i>
                            <div>
                                <h5>What we commit is what you get</h5>
                                <p>Strive for the best solution in committed time and expenses without any hiccups</p>
                            </div>
                        </li>
                    </ul>
                    <p>
                       We value our efforts as much as the requirements.  
                    </p>
                </div>
            </div>
    ...
    <section id="services" class="services">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                ...
                <p>We offer software development in variety of domains. Some of them are listed below</p>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        ...
                        <p>Any application based on web such as normal websites, Portals, CRM,ERP,Video Conferencing services etc.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
                    <div class="icon-box">
                        ...
                        <p>Native as well as hybrid mobile application development for android and ios</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
                    <div class="icon-box">
                        <div class="icon"><i class="bx bx-tachometer"></i></div>
                        <h4><a href="">Desktop Applications</a></h4>
                        <p>Light weight and robust desktop based application for windows operating system</p>
                    </div>
                </div>
            ...
            <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    ...
                    <div class="portfolio-info">
                        <h4>Web 3</h4>
                        <p>Web</p>
                        <a href="{{asset('public/assets/img/portfolio/portfolio-2.jpg')}}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 3"><i class="bx bx-plus"></i></a>
                        <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                    ...
                    <div class="portfolio-info">
                        <h4>App 2</h4>
                        <p>App</p>
                        <a href="{{asset('public/assets/img/portfolio/portfolio-3.jpg')}}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="App 2"><i class="bx bx-plus"></i></a>
                        <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                    </div>
                </div>
    ...
    <section id="contact" class="contact">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                ...
                <p>We are easy to be reached. contact us by sending us message directly</p>
            </div>
